      ...
      <div className="header_section">
         <div className="container">
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
               <a className="navbar-brand"href="index.html"><img src="/public/images/logo.png"/></a>
         ...
         <div className="container">
            <div className="about_section_2">
               <div className="row">
                  ...
                  <div className="col-md-6"> 
                     <div className="image_iman"><img src="/public/images/about-img.png" className="about_img"/></div>
                  </div>
               </div>
            </div>
         </div>
                     ...
                     <div className="container-fluid">
                        <div className="row">
                           <div className="col-lg-3 col-md-6">
                              <div className="coffee_img"><img src="/public/images/img-1.png"/></div>
                           ...
                           <div className="col-lg-3 col-md-6">
                              <div className="coffee_img"><img src="/public/images/img-2.png"/></div>
                              <div className="coffee_box">
                           ...
                           <div className="col-lg-3 col-md-6">
                              <div className="coffee_img"><img src="/public/images/img-3.png"/></div>
                              <div className="coffee_box">
                           ...
                           <div className="col-lg-3 col-md-6">
                              <div className="coffee_img"><img src="/public/images/img-4.png"/></div>
                              <div className="coffee_box">
                     ...
                     <div className="client_section_2">
                        <div className="client_taital_main">
                           <div className="client_left">
                              <div className="client_img"><img src="/public/images/client-img1.png"/></div>
                           </div>
               ...
               <div className="row">
                  <div className="col-md-6">
                     <div className="blog_box">
                        <div className="blog_img"><img src="/public/images/blog-img1.png"/></div>
                  ...
                  <div className="col-md-6">
                     <div className="blog_box">
                        <div className="blog_img"><img src="/public/images/blog-img2.png"/></div>
                        <h4 className="date_text">05 April</h4>
               ...
               <div className="col-md-12">
                  ...
                  <div className="location_text">
                     <ul>
                        <li>
                           <a href="#">
                           <i className="fa fa-phone" aria-hidden="true"></i><span className="padding_left_10">+01 1234567890</span>
                           </a>
                        </li>
                        <li>
                           <a href="#">
                           <i className="fa fa-envelope" aria-hidden="true"></i><span className="padding_left_10">demo@gmail.com</span>
                           </a>
                        </li>
                     </ul>
                  </div>
